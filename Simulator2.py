...
# target number of lunges in a set
T = 110

# integer if manual, None is selected by athlete
MANUAL_WEIGHT = 180
...
class Simulator2:
    ...
    def plotParamEvolutions(self):
        ...
        for (param, evol) in avgParamEvolution.items():
            ...
            ax.set_title("Avg {} evol in {} epochs, Model 2\nl={}, h={}, w={}".format(param, SIMULATION_EPOCHS, FITNESS, HEIGHT,
                                                                              MANUAL_WEIGHT))
            ax.set_xlabel("t")
    ...
    def plotFailinPoints(self):
        ...
        ax.set_title("Failing points, {} epochs, Model 2\nl={}, h={}, w={}".format(SIMULATION_EPOCHS, FITNESS, HEIGHT,
                                                                                     MANUAL_WEIGHT))
        ax.set_xlabel("t")
